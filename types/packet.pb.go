...
// ForwardingPacketData defines a list of port ID, channel ID pairs determining the paths
...
type ForwardingPacketData struct {
	...
	// optional intermediate paths through which packet will be forwarded.
